...
@section('content')
    <section class="py-20 bg-[#e7e8ea]">
        ...
        <div x-data="{ tab: 'tab6' }" class="space-y-10">
            ...
            <div x-show="tab === 'tab1'" class=""><x-frontend.charge.akuntansi-perpajakan :data="config('web-data.charges.akuntansi_perpajakan')"/></div>
            ...
            <div x-show="tab === 'tab6'"><x-frontend.charge.akuntansi-perpajakan :data="config('web-data.charges.consultasi')"/></div>
        </div>
    </section>
@endsection
